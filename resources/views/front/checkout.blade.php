                        ...
                        <div class="checkout-steps-form-style-1">
                            <ul id="accordionExample">
                                ...
                                <li>
                                    ...
                                    <section class="checkout-steps-form-content collapse" id="collapsePricing"
                                        aria-labelledby="headingPricing" data-bs-parent="#accordionExample">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="checkout-sidebar-price-table mt-3">
                                                    <div class="sub-total-price">
                                                        <div class="total-price">
                                                            <p class="value">Subtotal Price:</p>
                                                            <p class="price">
                                                                {{ \App\Helpers\Currency::format($cart->total()) }}</p>
                                                        </div>
                                                    ...
                                                    <div class="checkout-payment-form mt-3">
